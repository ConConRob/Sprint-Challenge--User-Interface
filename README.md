...
Semantic HTML describes itself. From looking at the html it is clear what it is

2. Name two big differences between ```display: block;``` and ```display: inline;```.
Display block creates a new line while inline doesn't.
Display block can have a set width while inline cannot.
